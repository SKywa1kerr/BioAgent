...
def extract_mutations(ref_g: str, qry_g: str, ref2_start: int, ref_len: int, is_circular: bool = True) -> List[Mutation]:
    muts = []
...
def analyze_sample(
    ...
    cds_cov = compute_cds_coverage(ref_g, qry_g, ref2_s, ref_len, cds_start, cds_end, is_circular=is_circular)
    frameshift = detect_frameshift(ref_g, qry_g, ref2_s, ref_len, cds_start, cds_end, is_circular=is_circular)
    ...
    cds_positions = compute_cds_covered_positions(ref_g, qry_g, ref2_s, ref_len, cds_start, cds_end, is_circular=is_circular)
    ...
    if ref2_s < ref_len and ref2_e <= ref_len:
        ...
        # matches: True for padding, True for match, False for mismatch/indel
        matches = []
        # Left padding
        ...
        for a, b in zip(ref_g, qry_g):
            if a != "-" and b != "-":
                ...
                matches.append(False) # Real indel
        # Right padding
